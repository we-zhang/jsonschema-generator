(function() {
	...
	*/
	var Utility = {
		isDateTimeString: function(value) {
			...
			var regEx = /^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[01])T([0-9]{2}):([0-9]{2}):([0-9]{2})(.[0-9]+)?([zZ]|([+-][0-9]{2}:[0-9]{2}))$/;
			return regEx.test(value);
		},
		isDateOnlyString: function(value){
			// RFC 3339 Date format '2016-11-22', http://tools.ietf.org/html/rfc3339#section-5.6
			var regEx = /^([0-9]{4})-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[01])$/;
			return regEx.test(value);
		},
